...
subtype (Forall _ td1 t1) (Forall _ td2 t2) = td2 <: td1 && t1 <: t2
...
isTopLike (Forall _ _ t) = isTopLike t
isTopLike _ = false
...
split (Forall a td t) = split t >>= \(Tuple t1 t2) ->
  Just $ Tuple (Forall a td t1) (Forall a td t2)
split _ = Nothing
