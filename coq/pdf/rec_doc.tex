...
%% For example, we cannot evaluates $\ottsym{\{}   \overrightarrow{  \mathbb{B}  }   \Rightarrow  \lambda  \ottmv{x}  \ottsym{.}   \mathsf{ \ottmv{b} }   \ottsym{\}}  \ottsym{.}   \overrightarrow{  \mathbb{B}  } $ in $\texttt{\textcolor{red}{<<no parses (char 3):  [-***];\{Base=>b\}  >>}} $.
...
%% \boxed{\texttt{\textcolor{red}{<<multiple parses>>}} = \texttt{\textcolor{red}{<<multiple parses>>}}} \hfill \textit{(Type translation)}
\begin{mathpar}
%% \inferrule{}{ \texttt{\textcolor{red}{<<multiple parses>>}} = \texttt{\textcolor{red}{<<multiple parses>>}} }
%% \and
%% \inferrule{}{ \texttt{\textcolor{red}{<<multiple parses>>}} = \texttt{\textcolor{red}{<<multiple parses>>}} }
%% \and
%% \inferrule{}{ \texttt{\textcolor{red}{<<multiple parses>>}} = \texttt{\textcolor{red}{<<multiple parses>>}} }
